  ...
  <div class="container-fluid">
    <div class="page-header mb-0 mt-0">
      <div class="pull-left">
        <h4>统计管理</h4>
        <breadcrumb
          v-bind:items="[{text: '统计管理'},{text:'分期用户还款统计报表',active:true}]"/>
      </div>
    </div>
        ...
        <div class="table-overflow">
          <table id="js-datatable_example" class="table table-bordered table-middle table-hover mt-1-5">
            ...
            <tr v-for="item in pageList.list">
              ...
              <td><a href="javascript:void(0);" v-on:click.prevent="showBillList(item.id)">{{item.installmentInfo.totalTerm}}</a></td>
  ...
  export default{
    ...
    methods: {
      exportCompany: function (data) {
        ...
        var url = api.statistic.exportInstallmentAmount.url;
        console.log(url);
